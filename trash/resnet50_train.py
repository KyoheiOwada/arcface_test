...
if __name__ == '__main__':
  ...
  train_loader = torch.utils.data.DataLoader(imgDataset, batch_size=64, shuffle=True, num_workers=0, pin_memory=True)
  ...
  for epoch in range(1, 500+1):
    torch.save(net.state_dict(), "./newmodel/resnet50_model_weight.pth")
