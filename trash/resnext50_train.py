...
if __name__ == '__main__':
  ...
  imgDataset = my_dataset.MyDataset(input_file_path,
                                    transform=transforms.Compose([transforms.RandomResizedCrop(224, scale=(0.85, 1.15)),
  ...
  train_loader = torch.utils.data.DataLoader(imgDataset, batch_size=48, shuffle=True, num_workers=0, pin_memory=True)
  val_loader = torch.utils.data.DataLoader(val_data, batch_size=8, shuffle=False,num_workers=0, pin_memory=True)
  ...
  #net.load_state_dict(torch.load('newmodel/resnet50_model_weight.pth'))
  ...
  for epoch in range(1, 500+1):
    torch.save(net.state_dict(), "./newmodel/resnext50_model_weight.pth")
    ...
    if (100. * correct / len(val_loader.dataset)) > 70:
      break
