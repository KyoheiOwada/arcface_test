...
if __name__ == '__main__':
  ...
  input_file_path = './utils/test_data.csv'
  ...
  test_loader = torch.utils.data.DataLoader(imgDataset, batch_size=32, shuffle=False,num_workers=0, pin_memory=True)
  ...
  net.load_state_dict(torch.load('newmodel/resnet18_model_weight1.pth'))
  print(net)
  #net = net.to(device)
  #criterion = nn.CrossEntropyLoss()
  #optimizer = optim.SGD(net.parameters(), lr=0.001, momentum=0.9)
  ...
  #  torch.save(net.state_dict(), "./newmodel/resnet18_model_weight2.pth")
